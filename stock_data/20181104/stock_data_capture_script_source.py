...
ts.day_boxoffice().to_csv(save_dir+'/'+capture_date+'_day_boxoffice.csv',header=True,sep=',',index=False)
...
ts.day_cinema().to_csv(save_dir+'/'+capture_date+'_day_cinema.csv',header=True,sep=',',index=False)
print('day_cinema data capture completed!')
ts.month_boxoffice().to_csv(save_dir+'/'+capture_date+'_month_boxoffice.csv',header=True,sep=',',index=False)
print('month_boxoffice data capture completed!')
ts.realtime_boxoffice().to_csv(save_dir+'/'+capture_date+'_realtime_boxoffice.csv',header=True,sep=',',index=False)
...
ts.get_index().to_csv(save_dir+'/'+capture_date+'_get_index.csv',header=True,sep=',',index=False)
print('get_index data capture completed!')

#get the history cpi data and save as csvfile named as the capture command
ts.get_cpi().to_csv(save_dir+'/'+capture_date+'_get_cpi.csv',header=True,sep=',',index=False)
...
ts.broker_tops().to_csv(save_dir+'/'+capture_date+'_broker_tops.csv',header=True,sep=',',index=False)
print('broker_tops data capture completed!')

#get detail information of the top brokers today and save as csvfile named as the capture command
ts.cap_tops().to_csv(save_dir+'/'+capture_date+'_cap_tops.csv',header=True,sep=',',index=False)
print('cap_tops data capture completed!')

ts.get_area_classified().to_csv(save_dir+'/'+capture_date+'_get_area_classified.csv',header=True,sep=',',index=False)
...
ts.get_day_all().to_csv(save_dir+'/'+capture_date+'_get_day_all.csv',header=True,sep=',',index=False)
print('get_day_all data capture completed!')
ts.get_cashflow_data(2018,3).to_csv(save_dir+'/'+capture_date+'_get_cashflow_data.csv',header=True,sep=',',index=False)
print('get_cashflow_data data capture completed!')
ts.get_concept_classified().to_csv(save_dir+'/'+capture_date+'_get_concept_classified.csv',header=True,sep=',',index=False)
print('get_concept_classified data capture completed!')
ts.get_debtpaying_data(2018,3).to_csv(save_dir+'/'+capture_date+'_get_debtpaying_data.csv',header=True,sep=',',index=False)
print('get_debtpaying_data data capture completed!')
ts.get_deposit_rate().to_csv(save_dir+'/'+capture_date+'_get_deposit_rate.csv',header=True,sep=',',index=False)
print('get_deposit_rate data capture completed!')

ts.get_gdp_contrib().to_csv(save_dir+'/'+capture_date+'_get_gdp_contrib.csv',header=True,sep=',',index=False)
ts.get_gdp_for().to_csv(save_dir+'/'+capture_date+'_get_gdp_for.csv',header=True,sep=',',index=False)
ts.get_gdp_pull().to_csv(save_dir+'/'+capture_date+'_get_gdp_pull.csv',header=True,sep=',',index=False)
ts.get_gdp_quarter().to_csv(save_dir+'/'+capture_date+'_get_gdp_quarter.csv',header=True,sep=',',index=False)
print('get_gdp_ data capture completed!')
#ts.get_gdp_year().to_csv(save_dir+'/'+capture_date+'_get_gdp_year.csv',header=True,sep=',',index=False)
ts.get_gem_classified().to_csv(save_dir+'/'+capture_date+'_get_gem_classified.csv',header=True,sep=',',index=False)
ts.get_gold_and_foreign_reserves().to_csv(save_dir+'/'+capture_date+'_get_gold_and_foreign_reserves.csv',header=True,sep=',',index=False)
ts.get_growth_data(2018,3).to_csv(save_dir+'/'+capture_date+'_get_growth_data.csv',header=True,sep=',',index=False)
ts.get_industry_classified().to_csv(save_dir+'/'+capture_date+'_get_industry_classified.csv',header=True,sep=',',index=False)
ts.get_hs300s().to_csv(save_dir+'/'+capture_date+'_get_hs300s.csv',header=True,sep=',',index=False)
ts.get_sz50s().to_csv(save_dir+'/'+capture_date+'_get_sz50s.csv',header=True,sep=',',index=False)
ts.get_zz500s().to_csv(save_dir+'/'+capture_date+'_get_zz500s.csv',header=True,sep=',',index=False)
ts.get_operation_data(2018,3).to_csv(save_dir+'/'+capture_date+'_get_operation_data.csv',header=True,sep=',',index=False)
ts.get_stock_basics().to_csv(save_dir+'/'+capture_date+'_get_stock_basics.csv',header=True,sep=',',index=False)
ts.get_report_data(2018,3).to_csv(save_dir+'/'+capture_date+'_get_report_data.csv',header=True,sep=',',index=False)
ts.inst_detail().to_csv(save_dir+'/'+capture_date+'_inst_detail.csv',header=True,sep=',',index=False)
ts.inst_tops().to_csv(save_dir+'/'+capture_date+'_inst_tops.csv',header=True,sep=',',index=False)
print('inst_tops data capture completed!')
ts.new_stocks().to_csv(save_dir+'/'+capture_date+'_new_stocks.csv',header=True,sep=',',index=False)
print('new_stocks data capture completed!')
ts.top_list().to_csv(save_dir+'/'+capture_date+'_top_list.csv',header=True,sep=',',index=False)
print('top_list data capture completed!')

print('All datas capture have completed!')
